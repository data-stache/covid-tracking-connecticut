...
New Cases  
Tdy (`r month(covid_ct$date[1])`-`r day(covid_ct$date[1])`): `r format(covid_ct$new_cases[1], big.mark = ",")` `r ifelse(covid_ct$new_cases[1] == max(covid_ct$new_cases, na.rm = TRUE), "*", "")`  
Yest (`r month(covid_ct$date[2])`-`r day(covid_ct$date[2])`): `r format(covid_ct$new_cases[2], big.mark = ",")`  
Lt Wk (`r month(covid_ct$date[8])`-`r day(covid_ct$date[8])`): `r format(covid_ct$new_cases[8], big.mark = ",")`  
<br></br>
New Tests  
T: `r format(covid_ct$new_tests[1], big.mark = ",")` `r ifelse(covid_ct$new_tests[1] == max(covid_ct$new_tests, na.rm = TRUE), "*", "")`  
Y: `r format(covid_ct$new_tests[2], big.mark = ",")`  
LW: `r format(covid_ct$new_tests[8], big.mark = ",")`  
<br></br>
Percent Positive  
T: `r round(covid_ct$percent_pos[1]*100, digits = 1)`%  
Y: `r round(covid_ct$percent_pos[2]*100, digits = 1)`%  
LW: `r round(covid_ct$percent_pos[8]*100, digits = 1)`%  
<br></br>
New Deaths  
T: `r format(covid_ct$new_deaths[1], big.mark = ",")` `r ifelse(covid_ct$new_deaths[1] == max(covid_ct$new_deaths, na.rm = TRUE), "*", "")`  
Y: `r format(covid_ct$new_deaths[2], big.mark = ",")`  
LW: `r format(covid_ct$new_deaths[8], big.mark = ",")`  
* = Record  
<br></br>
