...
Yest (`r month(covid_ct$date[2], label = TRUE)`-`r day(covid_ct$date[2])`): `r format(covid_ct$new_cases[2], big.mark = ",")`  
Lst Wk (`r month(covid_ct$date[8], label = TRUE)`-`r day(covid_ct$date[8])`): `r format(covid_ct$new_cases[8], big.mark = ",")`  
<br></br>
New Tests  
